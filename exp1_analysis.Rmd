...
```{r}
#The most convenient way to calculate differences from block to block is to restructure the data to wide format.
exp1.change.in.diffs.data <- tidyr::spread(data=dplyr::select(exp1.change.data.for.plotting,-ParticipantID),Participant,Change)

exp1.change.in.diffs.data$DifferenceInChange <- exp1.change.in.diffs.data$P1 - exp1.change.in.diffs.data$P2
...
ggplot(data=subset(exp1.change.in.diffs.data,BlockToBlock=="Training to Recall 1"), aes(x=Condition, y=DifferenceInChange, fill=Condition)) +
  theme_bw() + 
  geom_boxplot() +
  expand_limits(y=1) +
  scale_fill_manual(values=c(my.colours[2],my.colours[1],my.colours[3])) +
...
```{r}
wilcox.test(subset(exp1.change.in.diffs.data,Condition=="Condition: 66-33" & BlockToBlock=="Training to Recall 1")$DifferenceInChange, 
            subset(exp1.change.in.diffs.data,Condition=="Condition: 83-17" & BlockToBlock=="Training to Recall 1")$DifferenceInChange)
```
...
ggplot(data=subset(exp1.change.in.diffs.data,BlockToBlock=="Recall 1 to Interaction Block 2"), aes(x=Condition, y=DifferenceInChange, fill=Condition)) +
  theme_bw() + 
  geom_boxplot() +
  expand_limits(y=1) +
  scale_fill_manual(values=c(my.colours[2],my.colours[1],my.colours[3])) +
...
```{r}
wilcox.test(subset(exp1.change.in.diffs.data,Condition=="Condition: 66-33" & BlockToBlock=="Recall 1 to Interaction Block 2")$DifferenceInChange, 
            subset(exp1.change.in.diffs.data,Condition=="Condition: 83-17" & BlockToBlock=="Recall 1 to Interaction Block 2")$DifferenceInChange)
```
...
ggplot(data=subset(exp1.change.in.diffs.data,BlockToBlock=="Recall 1 to Recall 2"), aes(x=Condition, y=DifferenceInChange, fill=Condition)) +
  theme_bw() + 
  geom_boxplot() +
  expand_limits(y=1) +
  scale_fill_manual(values=c(my.colours[2],my.colours[1],my.colours[3])) +
...
```{r}
wilcox.test(subset(exp1.change.in.diffs.data,Condition=="Condition: 66-33" & BlockToBlock=="Recall 1 to Recall 2")$DifferenceInChange, 
            subset(exp1.change.in.diffs.data,Condition=="Condition: 83-17" & BlockToBlock=="Recall 1 to Recall 2")$DifferenceInChange)
```
